...
description: How to Stop a Dog from Jumping on Guests. Management + replacement behavior plan. Expert guidance for every dog owner.
pubDate: 2026-05-14
author: The PupWiki Team
category: Training
tags:
  - stop dog jumping on people
  - dog jumping greetings
...
Understanding stop dog jumping on people starts with knowing what drives the behaviour. Management + replacement behavior plan. This guide covers the root causes, practical steps and products that help.

## Understanding the Problem

> **Note:** Avoid kneeing or physical corrections.
...
| Product | Notes |
| --- | --- |
| **training clicker** | See Amazon search: `dog training clicker` |
| **short indoor traffic leash** | See Amazon search: `indoor dog leash short` |
| **non-slip place mat** | See Amazon search: `dog place mat training` |
...
- [stop dog begging at table](/blog/stop-dog-begging-at-table)
- [training an adult dog](/blog/training-an-adult-dog)
- [stop dog whining](/blog/stop-dog-whining)
