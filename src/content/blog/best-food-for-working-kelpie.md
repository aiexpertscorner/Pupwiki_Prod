...
breedEnergy: "active"
breedCoat: "double"
tags: ["dog-food", "working-kelpie", "medium-breed", "nutrition", "reviews", "2026"]
readTime: 8
topProduct:
...
seoTitle: "Working Kelpie Formula Fit: Kibble, Protein, and Feeding Notes"
displayTitle: "Working Kelpie formula fit: kibble, protein, and feeding notes"
titlePattern: "food-formula-fit"
cluster: "dog-food"
productFamilies: ["food", "dog-food"]
awinTopicTags: ["food", "dog-food", "dog food", "Dog Food", "working-kelpie", "Working Kelpie", "medium", "active", "difficult", "double", "nutrition", "feeding", "fresh-food", "raw-food", "sensitive-stomach", "treats", "bowls", "storage", "puppy", "senior-dog"]
...
---
## How to choose food for a Working Kelpie
Working Kelpie owners get the best results when they start with the dog in front of them: age, size, energy, coat, health history, and daily routine. Use this guide as a comparison framework, then confirm current details on the product or service page before making a decision.
...
## Shortlist for Working Kelpie owners
...
---
## Why Working Kelpie nutrition needs its own checklist
High-energy Working Kelpies burn significantly more calories per pound than sedentary dogs. Look for 28–34% protein and adequate fat (15%+) to support muscle recovery and sustained energy.
At 28–60 lbs (12.7–27.22 kg), Working Kelpies have flexibility in food choice but benefit from formulas matched to their specific energy expenditure.
The most common feeding mistakes Working Kelpie owners make:
- **Overfeeding** — Working Kelpies are food-motivated. Measure every meal and reduce treats from the daily allowance.
...
---
## Working Kelpie food picks and trade-offs
...
**Why it works for Working Kelpies:** This formula is matched to the Working Kelpie's medium size and active energy profile.
**What you get:**
...
**Best for:** medium Working Kelpies in the adult life stage with active activity levels.
---
...
**Why it's still a solid choice:** Not every family can spend $70+ per bag. The Farmer's Dog Fresh Dog Food delivers adequate nutrition for Working Kelpies at a lower price point — it won't outperform the premium picks, but it won't let your dog down either.
---
...
---
## Life Stage Guide for Working Kelpies
### Puppy (0–12 months)
...
Best option: The Farmer's Dog Fresh Dog Food
---
## How to Choose the Right Food for Your Working Kelpie
...
Active Working Kelpies: 28–34% protein minimum.
### Step 3: Check for joint support ingredients
Joint supplements in food are a welcome bonus for Working Kelpies, especially as they age.
...
---
## Common Working Kelpie Health Issues Affected by Diet
...
**Q: How much should I feed my Working Kelpie?**
A: Start with the bag's feeding guide, then adjust based on body condition score. A healthy Working Kelpie has a visible waist tuck and you can feel (but not see) their ribs. Working Kelpies weigh 28–60 lbs (12.7–27.22 kg) at healthy adult weight.
**Q: How often should Working Kelpies eat?**
...
**Q: Is grain-free better for Working Kelpies?**
A: Not inherently. Unless your Working Kelpie has a confirmed grain allergy, a quality grain-inclusive formula is nutritionally sound and avoids the ongoing FDA DCM investigation.
**Q: Should I add supplements to my Working Kelpie's food?**
...
**Q: How do I know if the food isn't suiting my Working Kelpie?**
...
**Q: What's the best food for a Working Kelpie with a sensitive stomach?**
...
---
## Our Verdict
For most Working Kelpie owners, **Taste of the Wild High Prairie** is the right call: it's matched to the Working Kelpie's breed profile, includes joint support, and has strong vet backing.
If your Working Kelpie is on a budget: **The Farmer's Dog Fresh Dog Food** delivers solid nutrition at a lower price point.
If you prefer grain-free: **Taste of the Wild High Prairie** is the most proven option — but discuss with your vet first.
**More Working Kelpie guides:**
- [Best toys for Working Kelpies →](/blog/best-toys-for-working-kelpie)
- [Best beds for Working Kelpies →](/blog/best-bed-for-working-kelpie)
- [Working Kelpie grooming guide →](/blog/best-grooming-for-working-kelpie)
- [Working Kelpie care hub →](/breeds/working-kelpie)
